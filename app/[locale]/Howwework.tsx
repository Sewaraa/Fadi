...
export default function HowWeWorkCreative() {
  ...
  return (
    <section
      className={`relative w-full bg-black px-4 py-28 ${isRTL ? "rtl" : ""}`}
    >
      <div className="mx-auto max-w-6xl">
        <div className="mb-20 text-center">
          ...
          <p className="mt-3 text-gray-400">{t.howWeWork.subtitle}</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          shadow-[0_0_80px_rgba(212,175,55,0.15)]
              ...
              >
                <div
                  className={`absolute -top-6 ${isRTL ? "right-8" : "left-8"}
